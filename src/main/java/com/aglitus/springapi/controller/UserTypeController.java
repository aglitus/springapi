...
public class UserTypeController {
    ...
    @PostMapping("")
    public ResponseEntity<UserType> save(@Valid @RequestBody UserType obj) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UserType> update(@PathVariable(value = "id") int id, @Valid @RequestBody UserType obj) {
